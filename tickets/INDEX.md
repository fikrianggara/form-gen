...
| TKT-028 | feature | small | P1 | admin-polish | done | jarvis | feature-TKT-028-users-table-kebab-action | true | Users table: kebab action menu (Edit, Reset password, Enable/Disable) + pure status badge |
| TKT-029 | feature | small | P1 | admin-polish | done | jarvis | feature-TKT-028-users-table-kebab-action | true | Disable user revokes active session (isActive checked at session verify) + self-lockout guard |
...
| TKT-022 | feature | small | P1 | invitation-hardening | backlog | null | null | false | Invitation.responseId as a real FK relation |
