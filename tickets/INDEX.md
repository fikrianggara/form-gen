...
| TKT-047 | feature | medium | P1 | public-api | ongoing | jarvis | feature-TKT-047-dev-role-operator-permis | false | DEV role — operator permissions + API key issuance (ISSUE_API_KEYS); portal approval stays admin-only |
...
| TKT-046 | feature | medium | P2 | public-api | done | jarvis | feature-TKT-046-swagger-ui-for-the-publi | true | Swagger UI for the public API spec — serve openapi.yaml + interactive docs endpoint |
