...
| TKT-001 | feature | big | respondent-auth | done | jarvis | feature-TKT-001-unique-link-distribution | true | Unique-link distribution & lazy response creation — mailblast sample links, no accounts |
...
| TKT-015 | bug | small | admin-polish | backlog | null | null | false | Questionnaire editor: added question and required toggle do not update until page reload |
