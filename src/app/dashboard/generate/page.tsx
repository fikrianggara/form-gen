  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <p className="mb-6 text-sm text-gray-500">
        ...
        retrieves matching questions from the question bank (RAG), predicts the title and
      ...
      <p className="mt-4 text-xs text-gray-400">
        Retrieval uses PostgreSQL trigram similarity over the latest question masters. When
        <code className="mx-1 rounded bg-gray-100 px-1">LLM_API_KEY</code>is configured, an
        OpenAI-compatible model generates the title and description; otherwise a deterministic
        extractive generator is used.
      </p>
    </div>
  );
}
